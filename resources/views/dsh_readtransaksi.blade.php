...
<div class="container text-Left">
  ...
  <li class="nav-item">
    ...
    <div class="col -10">
      <br>
    <a class="btn btn-primary" href="/tambahtransaksi" role="button"><i class="fa-solid fa-plus"></i> Tambah Pinjam</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="/deletetransaksi/{{ $t->id }}" class="btn btn-danger">Hapus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
