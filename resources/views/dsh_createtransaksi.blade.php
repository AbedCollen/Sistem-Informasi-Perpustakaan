...
<div class="container text-Left">
  ...
  <li class="nav-item">
    ...
    <div class="col -10">
    <form method="post" action="/create_transaksi">
            {{csrf_field()}}
            <div class="mb-3">
             <label for="exampleFormControlInput1" class="form-label">Nama Peminjam</label>
            <input type="text" name="nama" class="form-control" id="exampleFormControlInput1" placeholder="Judul Buku">
            </div>
            <div class="mb-3">
             <label for="exampleFormControlInput1" class="form-label">Tanggal Pinjam</label>
            <input type="date" name="pinjam" class="form-control" id="exampleFormControlInput1" >
            </div>
           
            <div class="mb-3">
             <label for="exampleFormControlInput1" class="form-label">Tanggal Masuk</label>
            <input type="date" name="balik" class="form-control" id="exampleFormControlInput1" >
            </div>
            <div class="d-grid gap-2 d-md-block">
            <input type="submit" value="Tambah Pinjam" type="button" class="btn btn-primary"></input>
            <a href ="/dashboard_transaksi" class="btn btn-secondary" type="button">cancel</a>
            </div>
