...
<div class="container text-Left">
  ...
  <li class="nav-item">
    ...
    <div class="col-10">
    <form method="post" action="/update_buku">
            {{csrf_field()}}
            @foreach($buku as $b) 
            ...
            <input type="date" name="tanggal_masuk" class="form-control" value="{{ $b->tanggal_masuk }}" >
            </div>
            @endforeach
            <div class="d-grid gap-2 d-md-block">
            <input type="submit" value="Update Buku" type="button" class="btn btn-primary"></input>
