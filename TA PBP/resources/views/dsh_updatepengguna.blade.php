...
<div class="container text-Left">
  ...
  <li class="nav-item">
    ...
    <div class="col-10">
    <form method="post" action="/update_pengguna">
            {{csrf_field()}}
            ...
            <input type="text" name="un" class="form-control" value="{{ $p->un }}" >
            </div>
            <div class="mb-3">
             <label for="exampleFormControlInput1" class="form-label">Password</label>
            <input type="password" name="pw" class="form-control" value="{{ $p->pw }}">
            </div>
            <div class="mb-3">
            ...
            <input type="text" name="role" class="form-control" value="{{ $p->role }}">
            </div>
            @endforeach
            <div class="d-grid gap-2 d-md-block">
            <input type="submit" value="Update User" type="button" class="btn btn-primary"></input>
