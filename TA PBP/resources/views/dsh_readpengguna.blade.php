...
<div class="container text-Left">
  ...
  <li class="nav-item">
    ...
    <div class="col -10">
      <br>
    <a class="btn btn-primary" href="/tambahpengguna" role="button"><i class="fa-solid fa-plus"></i> Tambah Pengguna</a>
      ...
      <button class="btn btn-outline-success" type="submit">Search</button>
        ...
        <tr>
            ...
            <tr>
                ...
                <td>{{ $p->telepon }}</td>
                <td>{{ $p->role }}</td>
                <td><button type="button" class="btn btn-success "><a href="/updateuser/{{ $p->id }}"><i class="fa-solid fa-pen-to-square text-white"></i></a></button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="/deleteuser/{{ $p->id }}" class="btn btn-danger">Hapus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
